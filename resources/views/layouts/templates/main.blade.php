...
<body>
    <div class="bg-white">
        {{-- Navbar --}}
        <header id="navbar" x-data="{ openSidebar: false }" @scroll.window="stickyNavbar"
            class="fixed inset-x-0 top-0 z-50 transition duration-500 ease-in-out">
            ...
            <div x-show="openSidebar" x-transition:enter="transition ease-out duration-500"
        ...
        <footer class="relative antialiased lg:mt-16 mt-28">
