        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <section class="not-format mt-5">
                    ...
                    @php
                        $co = $comments->where('parent_id', '=', 0);
                    @endphp
                    @foreach ($co as $comment)
                        <article
                            class="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900 @if ($loop->iteration > 1) {{ 'border-t border-gray-200 dark:border-gray-700' }} @endif">
                                            ...
                                            <footer class="flex justify-between items-center mb-2">
                                                <div class="flex items-center">
                                                    <p
                                                        ...
                                                        <img class="mr-2 w-6 h-6 rounded-full"
                                                            src="https://flowbite.com/docs/images/people/profile-picture-5.jpg"
                                                            alt="Jese Leos">{{ $r->user->name }}
                                                    </p>
                                                    <p class="text-sm text-gray-600 dark:text-gray-400"><time pubdate
                                                            datetime="{{ $r->updated_at->format('Y-m-d') }}"
                                                            title="{{ $r->updated_at->format('F jS, Y') }}">{{ $r->updated_at->format('M. j, Y') }}</time>
                                                    </p>
                                                </div>
                                                <button id="dropdownComment{{ $r->id }}Button"
                                                    data-dropdown-toggle="dropdownComment{{ $r->id }}"
                                                    class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:text-gray-400 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                                    type="button">
