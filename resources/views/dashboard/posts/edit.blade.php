        ...
        <div class="bg-white p-6 sm:rounded-lg">
            ...
            <form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
                ...
                <div id="default-tab-content">
                    {{-- Tab 1 --}}
                    <div class="hidden rounded-lg border-b bg-gray-50 p-4 dark:bg-gray-800" id="basic" role="tabpanel"
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="mb-3 w-full">
                                <label for="image"
                                    ...
                                    Image</label>
                                @if ($post->image)
                                    <img src="{{ asset('storage/' . $post->image) }}" class="img-preview mb-3 w-full">
                                @else
                    ...
                    {{-- Tab 2 --}}
                    <div class="hidden rounded-lg border-b bg-gray-50 p-4 dark:bg-gray-800" id="advance"
                        role="tabpanel" aria-labelledby="advance-tab">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                <label for="metaTitle"
