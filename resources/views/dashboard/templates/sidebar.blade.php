<aside id="default-sidebar"
    class="fixed lg:pt-16 pt-14 top-0 left-0 z-40 w-64 h-screen transition-[width,_transform] duration-500 sm:translate-x-0 -translate-x-full"
    aria-label="Sidenav">
    <div
        ...
        <ul class="space-y-2">
            <li class="{{ Request::is('dashboard') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="/dashboard"
                    ...
                    <span id="textMenu" class="ml-3">Overview</span>
                </a>
            </li>
            <li class="{{ Request::is('dashboard/posts*') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="/dashboard/posts"
                    ...
                    <span id="textMenu" class="flex-1 ml-3 text-left whitespace-nowrap">Posts</span>
                </a>
            </li>
            <li>
                <button type="button"
                    ...
                    <span id="textMenu" class="flex-1 ml-3 text-left whitespace-nowrap">Sales</span>
            ...
            <li>
                <a href="#"
                    ...
                    <span id="textMenu" class="flex-1 ml-3 whitespace-nowrap">Messages</span>
                </a>
            </li>
            <li>
                <button type="button"
                    ...
                    <span id="textMenu" class="flex-1 ml-3 text-left whitespace-nowrap">Authentication</span>
                    <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
        ...
        <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
            <li>
                <a href="#"
                    ...
                    <span id="textMenu" class="ml-3">Docs</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span id="textMenu" class="ml-3">Components</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span id="textMenu" class="ml-3">Help</span>
                </a>
            </li>
        </ul>
    </div>
    ...
    <div id="tooltip-settings" role="tooltip"
        class="inline-block absolute invisible z-[999] py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
        Settings page
