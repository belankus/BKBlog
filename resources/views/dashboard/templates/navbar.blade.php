<header class="antialiased">
    <nav class="bg-white border-b border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 fixed top-0 z-50 w-full">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar"
                    ...
                    class="inline-flex items-center p-2 mr-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                ...
                <a href="#" class="flex mr-4">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BKBlog</span>
                </a>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                    id="dropdown">
                    <div class="py-3 px-4">
                        <span class="block text-sm font-semibold text-gray-900 dark:text-white">Bellawan
                            Kusuma</span>
                        <span
                            class="block text-sm text-gray-500 truncate dark:text-gray-400">me@bellawan.my.id</span>
                    </div>
