                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-1" x-data="{
                        ...
                        <input type="hidden" name="parent_id" id="parent_id"
                            x-bind:value="selectedCategory.id ? selectedCategory.id : '{{ old('parent_id') }}'">
                        <div class="group relative inline-block w-full">
                            <button type="button"
                                ...
                                <div x-text="selectedCategory ? selectedCategory.name : '{{ old('parent_id') ? ($parentCategory = $categories->where('id', old('parent_id'))->first()->name) : 'Select Related Category' }}'"
                    ...
                    <div class="sm:col-span-1" x-data="{ showPreview: false, icon: `{{ old('icon') }}` }">
                        <div class="mb-4">
                            ...
                            <textarea x-text="`{{ old('icon') }}`" id="icon" name="icon" x-model="icon"
