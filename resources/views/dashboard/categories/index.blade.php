...
@section('content')
    ...
    <div class="px-4">
        ...
        <div class="mt-4 rounded-md bg-white p-6 shadow">
            <h1 class="text-2xl font-bold text-gray-400">All Categories</h1>
        </div>
                    ...
                    get filteredCategories() {
                        ...
                        if (this.searchQuery) {
                            filteredCategories = filteredCategories.filter(category => {
                                return category.name.toLowerCase().includes(this.searchQuery.toLowerCase()) || category.slug.toLowerCase().includes(this.searchQuery.toLowerCase());
                            });
                        }
                            ...
                            <template x-for="(category,index) in paginatedCategories" :key="category.id">
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        x-text="category.name" x-bind:title="category.name"></th>
                                    <td class="w-26 px-4 py-3" x-text="category.slug"></td>
                                    <td class="truncate whitespace-nowrap px-4 py-3">
                                        <span x-text="category.posts.length"></span>
                                    ...
                                    <td class="flex items-center justify-end px-4 py-3" x-data="{ open: false }"
                                        ...
                                        <button x-bind:id="category.id + 'btn'" @click="open = !open"
                                        ...
                                        <div x-bind:id="'category' + category.id" x-show="open"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                ...
                                                <li>
                                                    <a x-bind:href="'/blog/categories/' + category
                                                        .slug"
                                                        target="_blank"
                                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                                </li>
                                                <li>
                                                    <a x-bind:href="'/dashboard/categories/' + category.slug + '/edit'"
                                            ...
                                            <div class="py-1">
                                                <button
                                                    @click="window.dispatchEvent(new CustomEvent('show-modal', { detail: { categoryData: category } }))"
    ...
    <div x-data="{ showModal: false, categoryData: { posts: '' } }" x-show="showModal"
        x-on:show-modal.window="showModal = true; categoryData = $event.detail.categoryData" style="display: none;">
        <div
            ...
            <div class="relative max-h-full w-full max-w-md p-4">
                <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 text-center md:p-5">
                        ...
                        <div x-show="categoryData.slug === 'general'">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Error !</h3>
                            <p class="mb-3 rounded bg-red-400 p-2 text-red-700">You're attemp to delete <b>General</b>
                                category which is default category.</p>
                            <button type="button" @click="showModal = false"
                        ...
                        <div x-show="categoryData.slug !== 'general'">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want
                                ...
                                delete
                                this category?</h3>
                            <p class="mb-3 rounded bg-red-400 p-2 text-red-700">Related Post to this category, will not
                                be
                                deleted. But changed to <b>General</b> category.</p>
                            <div
                                ...
                                <p class="px-5">ID</p>
                                <p>:</p>
                                <p class="indent-2" x-text="categoryData.id"></p>
                                <p class="px-5">Contain Post</p>
                                <p>:</p>
                                <p class="indent-2" x-text="categoryData.posts.length"></p>
                                <p class="px-5">Category Name</p>
                                <p>:</p>
                                <p class="indent-2" x-text="categoryData.name"></p>
                            </div>
                            <form x-bind:action="'/dashboard/categories/' + categoryData.slug" method="post"
                                class="inline">
                                @method('delete')
                                @csrf
                                <button type="submit"
